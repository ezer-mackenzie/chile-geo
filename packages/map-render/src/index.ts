...
export { Chile3DMap } from './maps/Chile3DMap.js';
export { CHILE_REGIONS, isChileRegionId } from './regions.js';
export type { BaseMapOptions, Map2DOptions, Map3DOptions, RegionColorContext, RegionColorScale, RegionData } from './types/index.js';
