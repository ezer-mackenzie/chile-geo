...
import { _ as watchDebounced, a as escapeRegExp, c as onKeyStroke, d as useLocalStorage, f as useScrollLock, g as tryOnScopeDispose, h as toArray, i as dataSymbol, l as unrefElement, m as notNullish, n as useRouter, o as inBrowser, p as useSessionStorage, r as pathToFile, s as computedAsync, t as useData, u as useEventListener } from "./app.js";
...
import { computed, createApp, defineComponent, markRaw, nextTick, onBeforeUnmount, onMounted, ref, shallowRef, toValue, unref, useSSRContext, watch, watchEffect } from "vue";
//#region ../../../../../@localSearchIndex
var _localSearchIndex_default = { "root": () => import("./@localSearchIndexroot.BBCcN33m.js") };
//#endregion
...
//#endregion
//#region node_modules/.bun/focus-trap@8.2.2/node_modules/focus-trap/dist/focus-trap.esm.js
/*!
* focus-trap 8.2.2
...
//#endregion
//#region node_modules/.bun/@vueuse+integrations@14.4.0+075b2274ff3584c3/node_modules/@vueuse/integrations/dist/useFocusTrap.js
/**
* Reactive focus-trap
*
...
//#endregion
//#region node_modules/.bun/vitepress@2.0.0-alpha.19+e0f0882b451eb1a8/node_modules/vitepress/dist/client/theme-default/support/lru.js
var LRUCache = class {
	max;
	cache;
	constructor(max = 10) {
...
//#endregion
//#region node_modules/.bun/vitepress@2.0.0-alpha.19+e0f0882b451eb1a8/node_modules/vitepress/dist/client/theme-default/support/translation.js
/**
...
//#endregion
//#region node_modules/.bun/vitepress@2.0.0-alpha.19+e0f0882b451eb1a8/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue?vue&type=script&setup=true&lang.ts
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			ssrRenderTeleport(_push, (_push) => {
				_push(`<div role="button"${ssrRenderAttr("aria-owns", results.value?.length ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-d40bac62><div class="backdrop" data-v-d40bac62></div><div class="shell" data-v-d40bac62><form class="search-bar" data-v-d40bac62><label${ssrRenderAttr("title", unref(translate)("button.buttonText"))} id="localsearch-label" for="localsearch-input" data-v-d40bac62><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-d40bac62></span></label><div class="search-actions before" data-v-d40bac62><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-d40bac62><span class="vpi-arrow-left local-search-icon" data-v-d40bac62></span></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("aria-activedescendant", selectedIndex.value > -1 ? "localsearch-item-" + selectedIndex.value : void 0)} aria-autocomplete="both"${ssrRenderAttr("aria-controls", results.value?.length ? "localsearch-list" : void 0)} aria-labelledby="localsearch-label" autocapitalize="off" autocomplete="off" autocorrect="off" class="search-input" id="localsearch-input" enterkeyhint="go" maxlength="64"${ssrRenderAttr("placeholder", unref(translate)("button.buttonText"))} spellcheck="false" type="search" data-v-d40bac62><div class="search-actions" data-v-d40bac62><span class="${ssrRenderClass([{ active: showSearchSpinner.value }, "search-loading"])}"${ssrRenderAttr("role", showSearchSpinner.value ? "status" : void 0)} aria-live="polite"${ssrRenderAttr("aria-label", showSearchSpinner.value ? "Loading search results" : void 0)} data-v-d40bac62></span>`);
				if (!disableDetailedView.value) _push(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-d40bac62><span class="vpi-layout-list local-search-icon" data-v-d40bac62></span></button>`);
				else _push(`<!---->`);
				_push(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-d40bac62><span class="vpi-delete local-search-icon" data-v-d40bac62></span></button></div></form><ul${ssrRenderAttr("id", results.value?.length ? "localsearch-list" : void 0)}${ssrRenderAttr("role", results.value?.length ? "listbox" : void 0)}${ssrRenderAttr("aria-busy", showSearchSpinner.value ? "true" : "false")}${ssrRenderAttr("aria-labelledby", results.value?.length ? "localsearch-label" : void 0)} class="results" data-v-d40bac62><!--[-->`);
				ssrRenderList(results.value, (p, index) => {
					_push(`<li${ssrRenderAttr("id", "localsearch-item-" + index)}${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} role="option" data-v-d40bac62><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{ selected: selectedIndex.value === index }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))}${ssrRenderAttr("data-index", index)} data-v-d40bac62><div data-v-d40bac62><div class="titles" data-v-d40bac62><span class="title-icon" data-v-d40bac62>#</span><!--[-->`);
					ssrRenderList(p.titles, (t, index) => {
						_push(`<span class="title" data-v-d40bac62><span class="text" data-v-d40bac62>${t ?? ""}</span><span class="vpi-chevron-right local-search-icon" data-v-d40bac62></span></span>`);
					});
					_push(`<!--]--><span class="title main" data-v-d40bac62><span class="text" data-v-d40bac62>${p.title ?? ""}</span></span></div>`);
					if (unref(showDetailedList)) {
						_push(`<div class="excerpt-wrapper" data-v-d40bac62>`);
						if (p.text) _push(`<div class="excerpt" inert data-v-d40bac62><div class="vp-doc" data-v-d40bac62>${p.text ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`<div class="excerpt-gradient-bottom" data-v-d40bac62></div><div class="excerpt-gradient-top" data-v-d40bac62></div></div>`);
					} else _push(`<!---->`);
					_push(`</div></a></li>`);
				});
				_push(`<!--]-->`);
				if (unref(filterText) && !results.value.length && enableNoResults.value) _push(`<li class="no-results" data-v-d40bac62>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-d40bac62>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
				else _push(`<!---->`);
				_push(`</ul><div class="search-keyboard-shortcuts" data-v-d40bac62><span data-v-d40bac62><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-d40bac62><span class="vpi-arrow-up navigate-icon" data-v-d40bac62></span></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-d40bac62><span class="vpi-arrow-down navigate-icon" data-v-d40bac62></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-d40bac62><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-d40bac62><span class="vpi-corner-down-left navigate-icon" data-v-d40bac62></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-d40bac62><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-d40bac62>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
			}, "body", false, _parent);
		};
	}
});
//#endregion
//#region node_modules/.bun/vitepress@2.0.0-alpha.19+e0f0882b451eb1a8/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue
...
VPLocalSearchBox_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.bun/vitepress@2.0.0-alpha.19+e0f0882b451eb1a8/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var VPLocalSearchBox_default = /*#__PURE__*/ _plugin_vue_export_helper_default(VPLocalSearchBox_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-d40bac62"]]);
//#endregion
